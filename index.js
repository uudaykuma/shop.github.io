var images = [
    'https://tse3.mm.bing.net/th/id/OIG1.XDK.wyfkFvIX5HCPZ9LJ?pid=ImgGn',
    // 'https://images.unsplash.com/photo-1543322748-33df6d3db806?ixid=MXwxMjA3fDB8MHxzZWFyY2h8Nnx8bWVucyUyMGZhc2hpb258ZW58MHx8MHw%3D&ixlib=rb-1.2.1&w=1000&q=80', 
    'https://media.istockphoto.com/photos/summer-womens-fashion-clothes-set-moms-jeans-suede-sneakers-cotton-picture-id1131409615?k=6&m=1131409615&s=612x612&w=0&h=jxKe9n70klayZpaO08EwvciPDHuk57hxnvFJoB_BURM=', 
    'https://images.pexels.com/photos/705164/computer-laptop-work-place-camera-705164.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500', 'https://wallpaperaccess.com/full/2087678.jpg'
];
...
async function category(c) {
    ...
    console.log('alldata', alldata) // sorted data
    const categoryProduct = alldata.filter(item => {
    ...
    displayProduct(categoryProduct, value)

    
}

function displayProduct(alldata, value) {
    ...
    alldata.forEach(element => {
        ...
        if (element.category === value) {
            ...
            cardDiv.append(img, h3, p, btn1)


            div.append(cardDiv) // appending all the created element into the parent div
